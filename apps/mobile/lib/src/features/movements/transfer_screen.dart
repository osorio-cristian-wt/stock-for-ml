...
/// tab Movimientos), estilo "carga de compra": se elige EXPLÍCITAMENTE de qué
/// depósito sale y a cuál llega, se marcan cantidades sobre los productos con
/// stock en el origen (las filas con movimiento ≠ 0 se resaltan) — a mano o
/// escaneando — y al confirmar se muestra el detalle de lo movido. Solo
/// control interno: una transferencia balanceada no cambia el disponible
/// total, así que no empuja nada a ML.
